    ...
    try {
      ...
      if (customavatar) {
        let embed = new Discord.MessageEmbed()
          ...
          .addField("<:right:955324360477007902> PNG", `[\`LINK\`](${customavatar})`, true)
          .addField("<:right:955324360477007902> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
          .addField("<:right:955324360477007902> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
          .setURL(customavatar)
        ...
        let embed = new MessageEmbed()
          .setAuthor(handlemsg(client.la[ls].cmds.info.avatar.author, {
            ...
            dynamic: true
          }), "https://discord.gg/ByrUwS7rKp")
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
          .addField("<:right:955324360477007902> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
          .addField("<:right:955324360477007902> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
          .addField("<:right:955324360477007902> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
