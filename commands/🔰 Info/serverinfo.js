  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      .setAuthor(client.getAuthor(client.la[ls].cmds.info.serverinfo.author + " " +  message.guild.name, message.guild.iconURL({
        dynamic: true
      }), "https://discord.com/api/oauth2/authorize?client_id=955305907699470366&permissions=8&scope=bot%20applications.commands"))
      ...
      embed.addField("**<:right:955324360477007902> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:Wrong:955323096640921632> \`No Channel\`"}`, true)
      embed.addField("**<:right:955324360477007902> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:Wrong:955323096640921632> \`No Channel\`"}`, true)
      embed.addField("**<:right:955324360477007902> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:Wrong:955323096640921632> \`No Channel\`"}`, true)

      embed.addField("**<:right:955324360477007902> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:right:955324360477007902> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:right:955324360477007902> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<a:Nitro_boosting_level:953509635229360178> \`" + message.guild.premiumSubscriptionCount + "\`", true)

      embed.addField(client.la[ls].cmds.info.serverinfo.field13, `<a:Nitro_boosting_level:953509635229360178> \`${boostlevel}\``, true)
      embed.addField(client.la[ls].cmds.info.serverinfo.field14, "👾 \`" + maxbitrate + " kbps\`", true)
      if(boosts >= 14){
          embed.addField(`**<:right:955324360477007902> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:Wrong:955323096640921632> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:right:955324360477007902> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:right:955324360477007902> SERVER DISCOVERY SPLASH:**`)
