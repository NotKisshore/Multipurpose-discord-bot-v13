  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:right:955324360477007902> **Name**', "```"+json.name+"```", true)
        .addField("<:right:955324360477007902> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:right:955324360477007902> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:right:955324360477007902> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
